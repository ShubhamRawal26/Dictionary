...
const VOCABULARY = {
  A: [
    ...
    { word: "Anchor", pronunciation: "/ˈæŋ.kər/", meaning: "A device for holding a ship in place against waves and wind.", example: "Drop the anchor so the ship does not drift away." },
    { word: "Angel", pronunciation: "/ˈeɪn.dʒəl/", meaning: "A messenger of kindness and guardian spirit.", example: "My grandmother is an angel who always helps others." },
    { word: "Angry", pronunciation: "/ˈæŋ.ɡri/", meaning: "Upset and showing bad temper because of an injustice.", example: "He took a deep breath so he would not sound angry." },
    { word: "Acorn", pronunciation: "/ˈeɪ.kɔːn/", meaning: "Oak tree seed cherished by woodland creatures.", example: "The chipmunk gathered an acorn in its furry cheeks." },
